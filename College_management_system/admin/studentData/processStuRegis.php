...
// echo $fname,$lname,$birth_day,$gender,
...
// prepare sql statement
 $sql = $connection->prepare("INSERT INTO studentList (FirstName,LastName,Date_Of_Birth,
...
<h2>
    <br>
    <a href="Register_new_student.php">Go Back</a>
</h2>
